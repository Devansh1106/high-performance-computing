// Addition of vectors (executing many blocks and many threads)
#include <stdio.h>
#include <stdlib.h>
...
int main(){
  ...
  // refers to a block
  int threads_per_block = 32; // 32 is called a warp (depends on architecture)
  int blocks_per_grid = (N + threads_per_block - 1)/ threads_per_block;
  add<<<blocks_per_grid, threads_per_block>>>(_a, _b, _c, N);
